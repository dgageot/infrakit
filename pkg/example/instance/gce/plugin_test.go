...
import (
	...
	mock_gcloud "github.com/docker/infrakit/pkg/example/instance/gce/mock/gcloud"
...
func TestNewGCEInstancePlugin(t *testing.T) {
	plugin := NewGCEInstancePlugin("project", "zone")
